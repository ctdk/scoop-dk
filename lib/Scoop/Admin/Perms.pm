...
sub have_perm {
	...
	foreach my $chkperm (@all_check){
		...
		# Experimental mojo recalculation here if we're checking a
		# tu perm. This should hopefully take care of the problems
		# where people edit tags and such when they haven't commented
